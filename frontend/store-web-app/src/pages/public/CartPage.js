...
export default function CartPage() {
  ...
  if (productsCart.length === 0) return   <div className="table-responsive mt-5">
      <div className="mt-5"><h1>No devices on your cart!</h1></div></div>;

  return (
    <div className="table-responsive mt-5">
      <div className="mt-5"><h1>Your Cart</h1></div>
        ...
        <tr key={product.product_id}>
          ...
          <td className="align-middle text-center">
            <div className="d-flex flex-column align-items-center">
              ...
              <div>${product.price} + ${product.iva} IVA</div>
            </div>
          </td>
